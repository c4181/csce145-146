...
public class SearchAndSort {
	...
	public static int linearSearchIter(int[] a, int val)
	{
		int checks = 0;
	...
	public static int binarySearchRecur(int[] a, int val, int minIndex, int maxIndex, int checks)
	{
		...
		if(val > a[midIndex])
		{
			return binarySearchRecur(a,val,midIndex+1,maxIndex,checks+1);
		}
		else
			return binarySearchRecur(a,val,minIndex,midIndex-1,checks+1);
	}
